  ...
  <TABLE class="table">
    ...
    <TR>
      ...
      <TD><input type="text" name="zipcode" size="7"
      			id="sample6_postcode" value="${Utility.checkNull(dto.zipcode)}">
    ...
    <TR>
      ...
      <TD><input type="text" name="address1" size="40"
      			id="sample6_address" value="${Utility.checkNull(dto.address1)}">
      			<input type="text" name="address2" size="40"
      			id="sample6_address2" value="${Utility.checkNull(dto.address2)}"></TD>
      <TD></TD>
    </TR>
    <TR>
      <TH>*직업</TH>
